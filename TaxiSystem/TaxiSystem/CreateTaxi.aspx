...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <div class="auto-style10">
        ...
        <asp:Button class="auto-style13" ID="Button1" runat="server" Text="Ryd felter" OnClick="Button1_Click" CssClass="auto-style20" style="width: 90px; height: 25px; position: absolute; left: 341px; top: 465px" />
        <br />
        <br />

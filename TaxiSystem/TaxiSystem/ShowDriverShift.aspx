<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageTaxiOwner.Master" AutoEventWireup="true" CodeBehind="ShowDriverShift.aspx.cs" Inherits="TaxiSystem.ShowDriverShift" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Chaufførvagt - Oversigt
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h3>Liste over chaufførvagter</h3>
        </div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TaxiSystemCS %>" SelectCommand="SELECT [Trafikbog], [Trafikbog s.] AS column1, [Dato], [Enheder], [Ture], [Km], [Kontrol], [Besatte], [U. meter] AS column2, [Fejlture], [A conto] AS A_conto, [Taxi km] AS Taxi_km, [Oprettet], [Status], [Fornavn], [Efternavn], [Fører], [Bevilling] FROM [vShift] WHERE ([Fører] = @Fører)">
            <SelectParameters>
                <asp:CookieParameter CookieName="TaxiDriverNo" Name="Fører" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>

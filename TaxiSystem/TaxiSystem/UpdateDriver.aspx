<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageTaxiOwner.Master" AutoEventWireup="true" CodeBehind="UpdateDriver.aspx.cs" Inherits="TaxiSystem.UpdateDriver" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Vis/Rediger chauffør
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h3>Vis/rediger chauffør (Alle felter med * skal udfyldes)</h3>
        </div>
        ...
        <table class="auto-style75">
            <tr>
                ...
                <td class="auto-style66">
                    <asp:TextBox ID="TextBox20" runat="server" Width="150px" TextMode="Number" Enabled="false"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style66">
                    <asp:TextBox ID="TextBox29" runat="server" Width="150px" TextMode="Email" Enabled="false"></asp:TextBox>
                </td>
                ...
                <td>
                    <table class="auto-style71">
                        ...
                        <tr>
                            ...
                            <td class="auto-style66">
                                <asp:TextBox ID="TextBox10" runat="server" Width="150px" TextMode="Number" Enabled="false"></asp:TextBox>
                            </td>
        ...
        <asp:Button runat="server" ID="Button1" CssClass="btn btn-default" OnClick="Button1_Click" Text="Tilbage" CausesValidation="False" Style="width: 68px; height: 36px; float: left; position: absolute; left: 478px; top: 750px" />

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="UpdateOwner.aspx.cs" Inherits="TaxiSystem.UpdateOwner" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Vis/Rediger vognmand
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h3>Vis/Rediger vognmand (Alle felter med * skal udfyldes)</h3>
        </div>
        ...
        <asp:Button runat="server" ID="Button1" CssClass="btn btn-default" OnClick="Button1_Click" Text="Tilbage" style="width: 68px; height: 36px; float: left; position: absolute; left: 477px; top: 635px"/>

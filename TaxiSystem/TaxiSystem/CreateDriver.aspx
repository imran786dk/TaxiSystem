...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    <div class="auto-style68">
            ...
            <tr>
                <td class="auto-style74">
                    <table class="auto-style71">
                        <tr>
                            <td class="auto-style72">Kørekort oplysninger:
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style72">Kørekortnr.:</td>
                        ...
                        <tr>
                            <td class="auto-style72">Førerkortnr.:</td>
                            <td class="auto-style36">
                        ...
                        <tr>
                            <td class="auto-style73">Førerkorts udløbsdato:</td>
        ...
        <asp:Button class="auto-style13" ID="Button1" runat="server" Text="Ryd felter" OnClick="Button1_Click" CssClass="auto-style54" />
        <br />
        <br />
